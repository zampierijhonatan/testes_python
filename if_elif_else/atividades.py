def atividades():
    try:
        ...
        if atia <= 2:
            ...
            print(f"Cuidado! Está chegando ao final do prazo da atividade A, você tem apenas {atia}\n")
        elif atib <= 2:
            print(f"\nO tempo total para realizar as atividades é de {total}\n")
            print(f"Cuidado! Está chegando ao final do prazo da atividade A, você tem apenas {atib}\n")
        elif atic <= 2:
            print(f"\nO tempo total para realizar as atividades é de {total}\n")
            print(f"Cuidado! Está chegando ao final do prazo da atividade A, você tem apenas {atic}\n")
